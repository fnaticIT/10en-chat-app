  ...
  return (
    <div className="channel-search__results">
      ...
      {!loading && !teamChannels.length ? (
        ...
        teamChannels?.map((channel, i) => <SearchResult channel={channel} focusedId={focusedId} key={i} setChannel={setChannel} type="channel" setToggleContainer={setToggleContainer} />)
      )}
      ...
      {!loading && !directChannels.length ? (
        ...
        directChannels?.map((channel, i) => <SearchResult channel={channel} focusedId={focusedId} key={i} setChannel={setChannel} type="user" setToggleContainer={setToggleContainer} />)
      )}
    </div>
  );
};
